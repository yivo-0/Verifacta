...
/// VERIFACTA_REQUIRE_CORPUS is set, and write down what actually ran either way.
/// </summary>
...
public class CorpusPresenceTests(ValidatorFixture fixture)
{
    ...
    public void The_rule_packs_are_restored()
    {
        ...
        Assert.True(fixture.Available, "the rule packs are not loadable; run 'verifacta rules restore'");
