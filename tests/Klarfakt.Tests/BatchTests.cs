...
/// <summary>
/// The folder-validation plumbing behind "klarfakt validate ./invoices". None of it was covered
/// while it was the command the README leads with.
/// </summary>
public class BatchTests : IDisposable
{
    private readonly string _root = Directory.CreateTempSubdirectory("klarfakt-batch").FullName;
