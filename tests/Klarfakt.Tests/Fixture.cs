...
internal static class Corpus
{
    ...
    /// a clean clone proves very little. CI sets KLARFAKT_REQUIRE_CORPUS, which turns anything
    ...
    internal static bool Required { get; } =
        Environment.GetEnvironmentVariable("KLARFAKT_REQUIRE_CORPUS") is { Length: > 0 };
